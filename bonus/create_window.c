...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/15 11:58:22 by nicordie          #+#    #+#             */
/*   Updated: 2024/02/15 11:58:23 by nicordie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_sprites(t_data *data)
{
	...
	data->enemy = mlx_xpm_file_to_image(data->mlx_ptr, "sprites/enemy.xpm", \
								&width, &height);
	if (!data->wall || !data->empty_space || !data->collectible \
		|| !data->exit || !data->player.player || !data->enemy)
